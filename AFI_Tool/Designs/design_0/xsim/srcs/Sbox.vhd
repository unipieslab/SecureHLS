...
architecture behav of Sbox is 
    ...
    "Sbox,hls_ip_2020_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100t-ftg256-2,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=15.703500,HLS_SYN_LAT=34,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=293,HLS_SYN_LUT=599,HLS_VERSION=2020_1}";
    ...
    signal zext_ln150_fu_223_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal y_0_1_fu_237_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal y_0_2_fu_244_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal t_1_G256_inv_fu_176_ap_ready : STD_LOGIC;
    signal t_1_G256_inv_fu_176_ap_return : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal zext_ln134_1_fu_227_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal y_0_fu_231_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    t_1_G256_inv_fu_176 : component G256_inv
    port map (
        ap_ready => t_1_G256_inv_fu_176_ap_ready,
        x => t_reg_100,
        ap_return => t_1_G256_inv_fu_176_ap_return);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((tmp_fu_186_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                ...
                p_0_i3_reg_167 <= zext_ln150_fu_223_p1;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                y_0_0_i_reg_88 <= y_0_1_fu_237_p3;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_fu_255_p3 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, tmp_fu_186_p3, ap_CS_fsm_state4, tmp_1_fu_255_p3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((tmp_1_fu_255_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    X2S_ce0_assign_proc : process(ap_CS_fsm_state4)
    begin
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state4, tmp_1_fu_255_p3)
    begin
        if (((tmp_1_fu_255_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state4, tmp_1_fu_255_p3)
    begin
        if (((tmp_1_fu_255_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    y_0_1_fu_237_p3 <= 
        y_0_fu_231_p2 when (trunc_ln132_reg_335(0) = '1') else 
        y_0_0_i_reg_88;
    y_0_2_fu_244_p3 <= 
        y_0_fu_231_p2 when (trunc_ln132_reg_335(0) = '1') else 
        t_reg_100;
    ...
    y_0_5_fu_315_p3 <= 
        y_0_3_fu_302_p2 when (trunc_ln132_1_reg_374(0) = '1') else 
        t_2_reg_144;
    y_0_fu_231_p2 <= (zext_ln134_1_fu_227_p1 xor y_0_0_i_reg_88);
    zext_ln134_1_fu_227_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(A2X_q0),32));
    ...
    zext_ln150_fu_223_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_1_G256_inv_fu_176_ap_return),31));
end behav;
