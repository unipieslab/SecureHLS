...
#
# Generated by export_simulation on Tue Mar 26 18:42:35 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './top_function.sh' script.

./top_function.sh -reset_run
...
./top_function.sh -noclean_files

For more information on the script, please type './top_function.sh -help'.
