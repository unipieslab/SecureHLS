...
HD_PWD='C:/MyWork/AFI_Tool/Vivado_Project/Vivado_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_function.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_function.tcl
